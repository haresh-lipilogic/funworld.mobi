...
$stmt1 = $conn1->prepare("INSERT INTO ".$dblog.".lp (url,param,receivetime) VALUES (?,?,?)");
	...
	http://gamebar.mobi/jo/za/cen/lp.php?clickid=pk16611506993834566&msisdn=9647800026715&operator=jo_ZAIN&identid=eyJtIjoiOTY0NzgwMDAyNjcxNSIsIm8iOiJJUV9aQUlOIiwicmkiOiIyMjYzOGYwYS1iM2EwLTQ5MmQtYTczMi01YjNjNTY4NmUwNWUiLCJ0IjoxNjYxMTUwNzAwMTM5LCJwIjp7fX0&timestamp=1661150700140
	...
	if (isset($_GET['msisdn']))
	{
		...
		$msisdn=$_GET['msisdn'];
		 ...
		 $url="https://gamebar.mobi/jo/za/cen/formreturn1?clickid=".$clickid."&identid=".$identid."&msisdn=".$msisdn."&operator=".$operator."&timestamp=".$timestamp."&sign=".$sign."&pin=0";
...
<?php
		 ...
		 $url="https://gamebar.mobi/jo/za/cen/formreturn1?clickid=".$clickid;
					...
					<div id="top-wrap">
					  <!--  <div data-x-role="price" class="price">Vodafone: 3 QAR every 3 days. Ooredoo: QAR 9/week.</div>-->
						...
						<form id="number-entry" action="<?php echo $url;?>">
							...
							<input type="number" id="number" maxlength="10" placeholder="ادخل رقم الهاتف +962" name="msisdn" required>
