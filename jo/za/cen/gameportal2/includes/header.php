...
<div class="navbar-wrapper">
   <nav class="navbar navbar-inverse navbar-static-top">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php?msisdn=<?php echo $msisdn; ?>"><img src="https://funworld.mobi/jo/za/cen/gameportal/includes/funworld.png" alt="" title="" style="height:50px"></a> </div>
    <div id="navbar" class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">
		...
		<?php
			...
			session_start();
		?>
      <li><a href="../unsub.php?clickid=<?php echo $clickid; ?>&msisdn=<?php echo $msisdn; ?>&language=<?php echo  $language;?>"><?php if($language==1){echo "Unsubscribe";} else{ echo "إلغاء الاشتراك";} ?> </a></li>
