...
$stmt1 = $conn1->prepare("INSERT INTO ".$dblog.".callback1 (url,param,receivetime) VALUES (?,?,?)");
	...
	exit;
	 ...
	 $trial=$array_data['payload']['usage-authorisation']['package']['price-point']['is-trial'];
		...
		$result1 = $conn1->query($sql);
			...
			if($charging=='first')
			{
				...
				if($trial=='true')
				{
					if($serviceid==1)
					{
					$data="Welcome You are subscribed to ".$servicename." at First Day Free there after R5 per day.To Unsubscribe,Go To http://funworld.mobi/worldforher/ ";
					}
					elseif ($serviceid==2)
					{
					$data="Welcome You are subscribed to ".$servicename." at First Day Free there after R5 per day.To Unsubscribe,Go To http://funworld.mobi/fitnesstips/ ";
					}
					elseif($serviceid==3)
					{
					$data="Welcome You are subscribed to ".$servicename." at First Day Free there after R2 per day.To Unsubscribe,Go To http://funworld.mobi/beautytips/ ";
					}
					else{
					$data="Welcome You are subscribed to ".$servicename." at First Day Free there after R5 per day.To Unsubscribe,Go To http://funworld.mobi/gamebar/ ";
					}
				}
				else{
					...
					if($serviceid==1)
					{
					$data="Welcome You are subscribed to ".$servicename." at R5 per day.To Unsubscribe,Go To http://funworld.mobi/worldforher/ ";
					}
					elseif ($serviceid==2)
					{
					$data="Welcome You are subscribed to ".$servicename." at  R5 per day.To Unsubscribe,Go To http://funworld.mobi/fitnesstips/ ";
					}
					elseif($serviceid==3)
					{
					$data="Welcome You are subscribed to ".$servicename." at  R2 per day.To Unsubscribe,Go To http://funworld.mobi/beautytips/ ";
					}
					else{
					$data="Welcome You are subscribed to ".$servicename." at  R5 per day.To Unsubscribe,Go To http://funworld.mobi/gamebar/ ";
					}
				...
				if($advid>0)
				{
				$callback=callback($clickid,$serviceid,$advid,$chage);
				}
			...
			if($charging_mode=='act1')
			{
				...
				if($serviceid==1){
				$data="You are subscribed to ".$servicename." at R5 per day. To Unsubscribe, Go To http://funworld.mobi/worldforher/ ";
				}
				elseif ($serviceid==2)
				{
				
					$data="You are subscribed to ".$servicename." at R5 per day. To Unsubscribe, Go To http://funworld.mobi/fitnesstips/ ";
				
				}
				elseif ($serviceid==3)
				{
					
					$data="You are subscribed to ".$servicename." at R2 per day. To Unsubscribe, Go To http://funworld.mobi/beautytips/ ";
					
				}
				else
				{
					
					$data="You are subscribed to ".$servicename." at R5 per day. To Unsubscribe, Go To http://funworld.mobi/gamebar/ ";
