...
if ($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	if($select=='Continue')
	{
		...
		//var_dump($selfcare['payload']["selfcare-subscriptions"]);
	 	//$subscriptionid=$selfcare['payload']["selfcare-subscriptions"]["subscription"][0]['id'];
		//if($subscriptionid =='')
	//	{
	//		$subscriptionid=$selfcare['payload']["selfcare-subscriptions"]["subscription"]["id"];
	//	}
		
		
		//echo "Hi=".$subscriptionid;exit;
		...
		$inactive=inactive($clickid,$xvczaacr2,$serviceid,$packageid,$txnid,$subscriptionid);
		
	//var_dump($inactive);exit;
		 $state=$inactive['payload']['inactivate-subscription-response']['success'];
		if($serviceid==1)
		{
			if($state=='true')
			{
			echo "<center><b><p style='font-size: 100;'>You have deactivated successfully from  world for Her . </b></p></center>";
		...
		else if($serviceid==2)
		{
			if($state=='true')
			{
			echo "<center><b><p style='font-size: 100;'>You have deactivated successfully from  Fitness Tips . </b></p></center>";
			...
			//unset($_SESSION['subid1']);
				...
				echo "<center><b><p style='font-size: 100;'>You have already deactivated successfully from  Fitness Tips . If you want to activate this service please <a href='http://funworld.mobi/vodacom/staging/index.php?planid=2'>click here</a></b></p></center>";
		...
		else if($serviceid==3)
		{
			...
			if($state=='true')
			{
			echo "<center><b><p style='font-size: 100;'>You have deactivated successfully from  Beauty tips .</b></p></center>";
			...
			//unset($_SESSION['subid2']);
				...
				echo "<center><b><p style='font-size: 100;'>You have already deactivated successfully from  Glambar . </b></p></center>";
		...
		else if($serviceid==5)
		{
			...
			if($state=='true')
			{
			echo "<center><b><p style='font-size: 100;'>You have deactivated successfully from  Glambar .</b></p></center>";
		...
		else
		{
			...
			if($state=='true')
			{
			echo "<center><b><p style='font-size: 100;'>You have deactivated successfully from  Gamebar . If you want to activate this service please <a href='http://funworld.mobi/vodacom/staging/index.php?planid=4'>click here</a></b></p></center>";
			...
			//unset($_SESSION['subid2']);
				...
				echo "<center><b><p style='font-size: 100;'>You have deactivated successfully from Gamebar .</p></center>";
	...
	//	echo "INSERT INTO ".$db.".subscriber (msisdn,clickid,advid, charging_mode,subscriptionstartdate, subscriptionenddate, amount, serviceid, servicename, servicecode, token, packageid, try,txnid,chargeid) values('$msisdn','$clickid','$advid','$charging_mode','$date','$date','$amount','$serviceid','$servicename','$servicecode','$data','$decoupling','$try','$txnid','$chargeid')";
...
{
	$title='World for Her';
	$logo='http://funworld.mobi/worldforher/image/logo.png';
	$img='http://funworld.mobi/worldforher/images/use2.jpg';
	$url='http://funworld.mobi/worldforher/';
	
}
else if($serviceid==2)
{
	$title='Fitness Tips';
	$logo='http://funworld.mobi/fitnessguru/images/Fitness-Guru.png';
	$img='http://funworld.mobi/fitnessguru/Banners/3.jpg';
	$url='http://funworld.mobi/fitnesstips/';
}
else if($serviceid==3)
{
	$title='Beautytips';
	$logo='http://funworld.mobi/beautytips/content/Beauty%20Tips%20Logo.png';
	$img='http://funworld.mobi/beautytips/Banners/2.jpg';
	$url='http://funworld.mobi/beautytips/';
	
}
else if($serviceid==5)
{
	$title='GlamBar';
	$logo='http://funworld.mobi/glamportal/image/logo.png';
	$img='http://funworld.mobi/glamportal/images/banner4.jpg';
	$url='http://funworld.mobi/glamportal/';
	
}
else
{
	$title='Gamebar';
	$logo='https://funworld.mobi/gamebar/images/gamebar.png';
	$img='http://gamebar.mobi/spain/gamebar/images/banner/banner3.jpg';
	$url='http://funworld.mobi/gamebar/';
...
<a href="<?php echo $url;?>" style="color:#C00">Home</a> |                     
  <a href="http://funworld.mobi/vodacom/tnc.html"style="color:#C00">Terms&Conditions </a>                     
