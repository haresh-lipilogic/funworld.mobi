...
$msisdn=0;
	...
	if (isset($_SERVER['HTTP_X_VCZA_ACR']))
	{
		...
		//$url="https://api.dcbprotect.com/sv_mobi/script";
			$params = array(
				'ti' => $clickid,
				'ts' => time(),
				'country' => 'ZA',
				'ru' => "http://funworld.mobi/vodacom/ru?clickid=$clickid",
				'rfu' => "http://funworld.mobi/vodacom/rfu?clickid=$clickid"
		 ...
		 $url="https://api.clfldcbprotect.com/sv_mobi/page-redirect?" .$queryString . "&s=" . $signature;
