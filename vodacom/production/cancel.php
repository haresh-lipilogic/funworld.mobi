	...
	//	}
		...
		else if($serviceid==2)
		{
			...
			//unset($_SESSION['subid1']);
				...
				echo "<center><b><p style='font-size: 100;'>You have already deactivated successfully from  Fitness Tips . If you want to activate this service please <a href='http://club.funzone.mobi/vodacom/staging/index.php?planid=2'>click here</a></b></p></center>";
		...
		else if($serviceid==3)
		{
			...
			//unset($_SESSION['subid2']);
				...
				echo "<center><b><p style='font-size: 100;'>You have already deactivated successfully from  Beauty tips . </b></p></center>";
		...
		else
		{
			...
			if($state=='true')
			{
			echo "<center><b><p style='font-size: 100;'>You have deactivated successfully from  Gamebar . If you want to activate this service please <a href='http://club.funzone.mobi/vodacom/staging/index.php?planid=4'>click here</a></b></p></center>";
...
else if($serviceid==2)
{
	...
	$url='http://club.funzone.mobi/fitnesstips/';
}
else if($serviceid==3)
{
	$title='Beautytips';
...
{
	$title='Gamebar';
	$logo='http://club.funzone.mobi/portugal/image/gamebar.png';
	$img='http://club.funzone.mobi/spain/gamebar/images/banner/banner3.jpg';
	$url='http://club.funzone.mobi/gamebar/';
