...
while (($data = fgetcsv($file1, 10000, ";")) !== FALSE) {
				...
				if($isfind > 0)
				{
					...
					if($charging1 !='dct')
					{
						...
						$stmt1->bind_param("sssssssssssssssss",$msisdn,$clickid,$advid, $charging,$date,$date,$amount,$serviceid,$servicename,$servicecode,$data,$packageid,$try,$txnid,$chargeid,$cbsent,$subcriptionid);	
						$stmt1->execute();
					}
