		...
		$result1 = $conn1->query($sql);
			...
			if($charging=='first')
			{
				...
				if($trial=='true')
				{
					if($serviceid==1)
					{
					$data="Welcome You are subscribed to ".$servicename." at First Day Free there after R5 per day.To Unsubscribe,Go To http://club.funzone.mobi/worldforher/ ";
					}
					elseif ($serviceid==2)
					{
					$data="Welcome You are subscribed to ".$servicename." at First Day Free there after R5 per day.To Unsubscribe,Go To http://club.funzone.mobi/fitnesstips/ ";
					}
					elseif($serviceid==3)
					{
					$data="Welcome You are subscribed to ".$servicename." at First Day Free there after R2 per day.To Unsubscribe,Go To http://club.funzone.mobi/beautytips/ ";
					}
					else{
					$data="Welcome You are subscribed to ".$servicename." at First Day Free there after R5 per day.To Unsubscribe,Go To http://club.funzone.mobi/gamebar/ ";
					}
				}
				else{
					...
					if($serviceid==1)
					{
					$data="Welcome You are subscribed to ".$servicename." at R5 per day.To Unsubscribe,Go To http://club.funzone.mobi/worldforher/ ";
					}
					elseif ($serviceid==2)
					{
					$data="Welcome You are subscribed to ".$servicename." at  R5 per day.To Unsubscribe,Go To http://club.funzone.mobi/fitnesstips/ ";
					}
					elseif($serviceid==3)
					{
					$data="Welcome You are subscribed to ".$servicename." at  R2 per day.To Unsubscribe,Go To http://club.funzone.mobi/beautytips/ ";
					}
					else{
					$data="Welcome You are subscribed to ".$servicename." at  R5 per day.To Unsubscribe,Go To http://club.funzone.mobi/gamebar/ ";
					}
			...
			if($charging_mode=='act1')
			{
				...
				elseif ($serviceid==2)
				{
					...
					$data="You are subscribed to ".$servicename." at R5 per day. To Unsubscribe, Go To http://club.funzone.mobi/fitnesstips/ ";
				...
				else
				{
					...
					$data="You are subscribed to ".$servicename." at R5 per day. To Unsubscribe, Go To http://club.funzone.mobi/gamebar/ ";
