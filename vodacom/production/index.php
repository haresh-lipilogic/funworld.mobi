...
//exit;
//echo "due to maintaince the service is unavailable";exit;
error_reporting(0);
...
if (isset($_SERVER['HTTP_X_VCZA_ACR']) || $_GET['test']==1)
{
  ...
  if($_GET['test']==1)
  {
  $xvczaacr='';
  }
	$msisdn=0;
	$operator='';
	   ...
	   if ($success>0)
	   {
		...
		$result1 = $conn1->query($sql);
		   ...
		   else if($serviceid==1)
		   {
			...
			echo '<body style="background:#ffe1e1;">
			<center>
			<img class="logosvg" style="height:15%; width:40%;" src="http://club.funzone.mobi/worldforher/image/logo.png"><b><p style=
			"font-size: 35;">You already subscribed this service.Kindly click on Below Button to use the service<br><br> <a href="http://club.funzone.mobi/worldforher/"><button style="height:15%;width:40%;font-size:35px;background-color: #4CAF50;color:white;border: none;border-radius: 12px;">Homepage</button></a></b></p></center>
			</body>';
			exit;
		   }
		   else if($serviceid==2)
		   {
			...
			echo '<body style="background:#ffe1e1;">
			<center>
			<img class="logosvg" style="height:15%; width:40%;" src="http://club.funzone.mobi/fitnesstips/images/Fitness-Guru.png"><b><p style=
			"font-size: 35;">You already subscribed this service.Kindly click on Below Button to use the service<br><br> <a href="http://club.funzone.mobi/fitnesstips/"><button style="height:15%;width:40%;font-size:35px;background-color: #4CAF50;color:white;border: none;border-radius: 12px;">Homepage</button></a></b></p></center>
			</body>';
			exit;
		   }
		   else
		   {
			...
			echo '<body style="background:#ffe1e1;">
			<center>
			<img class="logosvg" style="height:15%; width:40%;" src="http://club.funzone.mobi/beautytips/content/Beauty%20Tips%20Logo.png"><b><p style=
			"font-size: 35;">You already subscribed this service.Kindly click on Below Button to use the service<br><br> <a href="http://club.funzone.mobi/beautytips/"><button style="height:15%;width:40%;font-size:35px;background-color: #4CAF50;color:white;border: none;border-radius: 12px;">Homepage</button></a></b></p></center>
			</body>';
			exit;
		   }
  ...
  // if($advertiserid=='14' || $advertiserid=='15' || $advertiserid=='16' || $advertiserid== '17' || $advertiserid=='1' || $advertiserid=='3' || $advertiserid=='20' || $advertiserid=='21' || $advertiserid=='22' || $advertiserid=='23')
	...
	//	if($advertiserid=='14' || $advertiserid=='15' || $advertiserid=='16' || $advertiserid== '17' || $advertiserid=='1' || $advertiserid=='3' || $advertiserid=='20' || $advertiserid=='21' || $advertiserid=='22' || $advertiserid=='23')	
		...
		<!--	<a href="http://club.funzone.mobi/worldforher/index.php" style="color:#C00">Home</a> |     -->                
			  <a href="http://club.funzone.mobi/vodacom/production/wfhtnc.html"style="color:#C00">Terms&Conditions </a>                     
		...
		?>	
			...
			<!--<a href="http://club.funzone.mobi/fitnessguru/index.php" style="color:#C00">Home</a> |        -->             
			  <a href="http://club.funzone.mobi/vodacom/production/fttnc.html"style="color:#C00">Terms&Conditions </a>                     
		...
		<!--	<a href="http://club.funzone.mobi/beautytips/index.php" style="color:#C00">Home</a> |-->                     
			  <a href="http://club.funzone.mobi/vodacom/production/bttnc.html"style="color:#C00">Terms&Conditions </a>                     
		...
		?>
			...
			<div id="textbox">      
				 <br> 
		<!--	<a href="http://club.funzone.mobi/beautytips/index.php" style="color:#C00">Home</a> |-->                     
			  <a href="http://club.funzone.mobi/vodacom/production/gametnc.html"style="color:#C00">Terms&Conditions </a>                     
