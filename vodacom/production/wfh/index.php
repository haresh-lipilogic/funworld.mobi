...
include "../includes/dbdetail.php";
	...
	$url='http://club.funzone.mobi/vodacom/index?planid=1&adid=14&clickid='.$clickid;
...
if (isset($_GET['p']))
{
	$p=$_GET['p'];
	$p=$p+12;
	$actual_link="http://club.funzone.mobi/worldforher/thesis.php?p=$p";
}
...
<img onclick="myFunction()" class="dropbtn" src="icon_menu.png">
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="http://club.funzone.mobi/worldforher/index.php">Home</a>
    <a href="<?php echo $actual_link;?>">Tips</a>
    <a href="http://club.funzone.mobi/worldforher/videos.php">Videos</a>
...
?>
					...
					<a href="http://club.funzone.mobi/worldforher/category.php?id=<?php echo $row['id'];?>">
