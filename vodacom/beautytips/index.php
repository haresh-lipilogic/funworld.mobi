...
error_reporting(0);
	...
	$mt = microtime(true);
		...
		$clickid = ((string)$mt*10).rand(1, 999)."m";
	$name='googlebeautytips';
	...
	$stmt1 = $conn1->prepare("INSERT INTO ".$dblog.".pagestrack (name,ip,referal,accesstime,msisdn,clickid,hedetail,url,googleclickid) VALUES (?,?,?,?,?,?,?,?,?)");
	$stmt1->bind_param("sssssssss",$name,$ip, $referrer,$accesstime,$msisdn,$clickid,$data,$pageurl,$googleclick);
	$stmt1->execute();
	
	


	$url='http://club.funzone.mobi/vodacom/index?planid=3&adid=15&clickid='.$clickid;
...
<head>
    ...
    <title>Welcome to BeautyTips1</title>
...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#" style="width: 70%">
                    <img src="http://club.funzone.mobi/beautytips/content/Beauty Tips Logo.png" alt="" title="" style="height: 52px; width: 80%" /></a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="http://club.funzone.mobi/beautytips/hairtips.php">Hair Tips</a></li>
					<li><a href="http://club.funzone.mobi/beautytips/health.php">Health & lifestyle</a></li>
                    <!--Racing Games-->
    ...
    <div class="container">
        <div class="categoryrow">
            ...
            <div class="list-row">
                <a href="http://club.funzone.mobi/beautytips/skincare.php">
                    <div class="listblock" style="width: 100%">
                        <div class="list-img">
                            <img src="http://club.funzone.mobi/beautytips/content/skin.jpg" alt="" title="" />
                        </div>
        ...
        <div class="categoryrow">
            ...
            <div class="list-row">
                <a href="http://club.funzone.mobi/beautytips/hairtips.php">
                    <div class="listblock" style="width: 100%">
                        <div class="list-img">
                            <img src="http://club.funzone.mobi/beautytips/content/hair.jpg" alt="" title="" />
                        </div>
                        <div class="list-details">
                            <div class="list-info">
	...
	<?php
	session_start();
$clickid=$_COOKIE["vodacom_beautytips_act"];
 ...
 <div class="toplinks">
    <ul>
     ...
     <li><a href="http://club.funzone.mobi/vodacom/cancel.php?serviceid=3&clickid=<?php //echo $clickid; ?>">Unsubscribe </a></li>
