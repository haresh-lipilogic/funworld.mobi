	...
	//var_dump($inactive);exit;
		...
		else if($serviceid==2)
		{
			...
			//unset($_SESSION['subid1']);
				...
				echo "<center><b><p style='font-size: 100;'>You have already deactivated successfully from  Fitness Tips . If you want to activate this service please <a href='http://funworld.mobi/vd/staging/index.php?planid=2'>click here</a></b></p></center>";
		...
		else
		{
			...
			if($state=='true')
			{
			echo "<center><b><p style='font-size: 100;'>You have deactivated successfully from  Gamebar . If you want to activate this service please <a href='http://funworld.mobi/vd/staging/index.php?planid=4'>click here</a></b></p></center>";
...
<a href="<?php echo $url;?>" style="color:#C00">Home</a> |                     
  <a href="http://funworld.mobi/vd/tnc.html"style="color:#C00">Terms&Conditions </a>                     
