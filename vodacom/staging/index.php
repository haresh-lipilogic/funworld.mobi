...
if($serviceid==2 || $serviceid== 1 || $serviceid==3 || $serviceid ==4 || $serviceid ==5)
{
	$mode='staging';
}
...
if (isset($_SERVER['HTTP_X_VCZA_ACR']) || $_GET['test']==1)
{
  ...
  if($_GET['test']==1)
  {
  $xvczaacr='';
  }
	$msisdn=0;
	$operator='';
	   ...
	   if ($success>0)
	   {
		...
		$result1 = $conn1->query($sql);
		   ...
		   if($serviceid==4)
		   {
			...
			<center>
			<img class="logosvg" style="height:15%; width:40%;" src="http://gamebar.mobi/portugal/image/gamebar.png"><b><p style=
		   ...
		   else if($serviceid==5)
		   {
			   ...
			   setcookie("vodacom_glambar_act", $clickid, time() + (86400 * 2), "/");
			   
			echo '<body style="background:#ffe1e1;">
			<center>
			<img class="logosvg" style="height:15%; width:40%;" src="http://funworld.mobi/glamportal/image/logo.png"><b><p style=
			"font-size: 35;">You already subscribed this service.Kindly click on Below Button to use the service<br><br> <a href="http://funworld.mobi/glamportal"><button style="height:15%;width:40%;font-size:35px;background-color: #4CAF50;color:white;border: none;border-radius: 12px;">Homepage</button></a></b></p></center>
			</body>';
			exit;
		   }
  ...
  // if($advertiserid=='14' || $advertiserid=='15' || $advertiserid=='16' || $advertiserid== '17' || $advertiserid=='1' || $advertiserid=='3' || $advertiserid=='20' || $advertiserid=='21' || $advertiserid=='22' || $advertiserid=='23')
	...
	//	if($advertiserid=='14' || $advertiserid=='15' || $advertiserid=='16' || $advertiserid== '17' || $advertiserid=='1' || $advertiserid=='3' || $advertiserid=='20' || $advertiserid=='21' || $advertiserid=='22' || $advertiserid=='23')	
		...
		<!--	<a href="http://funworld.mobi/worldforher/index.php" style="color:#C00">Home</a> |     -->                
			  <a href="http://funworld.mobi/vd/wfhtnc.html"style="color:#C00">Terms&Conditions </a>                     
		...
		?>	
			...
			<!--<a href="http://funworld.mobi/fitnessguru/index.php" style="color:#C00">Home</a> |        -->             
			  <a href="http://funworld.mobi/vd/fttnc.html"style="color:#C00">Terms&Conditions </a>                     
		...
		<!--	<a href="http://funworld.mobi/beautytips/index.php" style="color:#C00">Home</a> |-->                     
			  <a href="http://funworld.mobi/vd/bttnc.html"style="color:#C00">Terms&Conditions </a>                     
		...
		?>
			...
			<body style="color:#b5171e ;background:#ffe1e1; font-size:12px">  
			<center> <img class="logosvg" style="height:10%; width:40%;" src="http://funworld.mobi/glamportal/image/logo.png"></center>      
			<div id="LogoDiv">             
			<a><img src="http://funworld.mobi/glamportal/glambar.jpg" width="640"  style="width:100%;height:15%"></a>         
			</div>         

			<div id="main">

			 <center>
			 <div class="home-faq"><h3>GlamourWorld </h3>
			 <h4>GlamourWorld  is a service that allows the customers unique content from international videos with unlimited downloads.</h4>
			 </div><center>         
			</div>         
			<form method="POST" style="font-size:10px">             
			<div style="text-align:center">                 
		...
		?>
			...
			<center> <img class="logosvg" style="height:10%; width:40%;" src="http://gamebar.mobi/spain/images/gamebar.png"></center>      
			<div id="LogoDiv">             
			...
			<div id="textbox">      
				 <br> 
		<!--	<a href="http://funworld.mobi/beautytips/index.php" style="color:#C00">Home</a> |-->                     
			  <a href="http://funworld.mobi/vd/gametnc.html"style="color:#C00">Terms&Conditions </a>                     
