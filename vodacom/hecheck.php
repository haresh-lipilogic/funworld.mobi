	...
	//	if($advertiserid=='14' || $advertiserid=='15' || $advertiserid=='16' || $advertiserid== '17' || $advertiserid=='1' || $advertiserid=='3' || $advertiserid=='20' || $advertiserid=='21' || $advertiserid=='22' || $advertiserid=='23')	
			...
			<!--
			  <p style="text-align:center">Un valor de %VALUE% se facturará o descontará de su saldo %OPERATOR%</h3>     
			   ...
			   <a href="<?php echo $url2; ?>"><input class="button button1" type="button" name="select" value="Subscribe">  </a>   
				...
				<p>Service with First Day Free From the Second day you will Charged R5.00 per day , discounted from the balance or invoice of communication and renewed automatically.</p>
		...
		?>	
			...
			<!--
			  ...
			  <!-- <center>%HIDDEN%</center>-->             
			 <div id="Footer">                 
			 <center><br>Fitness Tips</br><center>                 
			 <div id="textbox">      
				 <br> 
			...
			<!--
			  <p style="text-align:center">Un valor de %VALUE% se facturará o descontará de su saldo %OPERATOR%</h3>     
			   ...
			   <a href="<?php echo $url2; ?>"><input class="button button1" type="button" name="select" value="Subscribe">  </a>   
				...
				<p>Service with First Day Free, From the Second day you will Charged R2.00 per day discounted from the balance or invoice of communication and renewed automatically.</p>
