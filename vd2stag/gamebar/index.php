...
<head>
    ...
    <title>Welcome to - Gameportal</title>
                    ...
                    <div class="banner-slider">
                        <center>
                            ...
                            <a href="<?php echo "dl.php?ir=".$result[0]['id'];?>"><img class="cost30"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[0]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[1]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[1]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[2]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[2]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[3]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[3]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[4]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[4]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[5]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[5]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[6]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[6]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[7]['id'];?>"><img class="nocost30"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[7]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[8]['id'];?>"><img class="nocost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[8]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[9]['id'];?>"><img class="nocost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[9]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[10]['id'];?>"><img class="nocost93"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[10]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[11]['id'];?>"><img class="nocost913"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[11]['medianame'];?>"></a>
                        ...
                        <center>
                            <!--<div class="numbertext">1 / 3</div>-->
                             <a href="<?php echo "dl.php?ir=".$result[35]['id'];?>"><img class="cost30"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[35]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[34]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[34]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[33]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[33]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[32]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[32]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[31]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[31]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[30]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[30]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[29]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[29]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[28]['id'];?>"><img class="nocost30"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[28]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[27]['id'];?>"><img class="nocost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[27]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[26]['id'];?>"><img class="nocost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[26]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[25]['id'];?>"><img class="nocost93"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[25]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[24]['id'];?>"><img class="nocost913"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[24]['medianame'];?>"></a>
                    ...
                    <div class="banner-slider">
                        <center>
                            <!--<div class="numbertext">1 / 3</div>-->
                                    ...
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[12]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[13]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[13]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[14]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[14]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[15]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[15]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[16]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[16]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[17]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[17]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[18]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[18]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[19]['id'];?>"><img class="nocost30"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[19]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[20]['id'];?>"><img class="nocost9"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[20]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[21]['id'];?>"><img class="nocost91"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[21]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[22]['id'];?>"><img class="nocost93"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[22]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[23]['id'];?>"><img class="nocost913"
                                    src="<?php echo "https://game.lkjgf.xyz/".$result[23]['medianame'];?>"></a>
			...
			<section class="container-fluid mb-3">
                <div class="row">
                    <div class="col titleContainer">
                        ...
                        <div class="viewmore"><a href="category.php?ct=MultiPlayer Games">View More</a></div>
                    </div>
                </div>
				<?php

				$sql1="call htmlgames.catmultiGames(25);";
						//$result1 = $conn->query($sql1);
							$result = array();
						foreach ($conn->query($sql1) as $row) {
							  $result[] = $row;
...
?>
			...
			<?php	
				...
				<div class="col"> <a href="<?php echo "dl.php?ir=".$row['id'];?>"><img src="<?php echo "https://game.lkjgf.xyz/".$row['medianame'];?>"></a>
                    </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="text-container">
                        <h5>Gamebar – Enjoy Free Unlimited Online Games</h5>
                        <div class="content hideContent">
                            <p><strong>Play the Newest Games Instantly</strong></p>
                            <p>Gamebar features the latest and best free online games. You can enjoy playing fun games
                                without
                            ...
                            <p><strong>Online Games at Gamebar</strong></p>
                            <p>There are plenty of Free Unlimited online games on Gamebar. You can find many of the
                                best games
                            ...
                            <p><strong>About Gamebar</strong></p>
                            <p>Gamebar.games is the world’s most well-known gaming website for free content consumption
                                on
