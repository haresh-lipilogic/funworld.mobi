    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="categoryrow">
				...
				<?php
				$sql_ad="SELECT * FROM vodacom_za_content.`beautytips_videos` WHERE `category`=1 order by rand() limit 10";
				$res_ad=mysqli_query($con,$sql_ad);
				while($row_ad=mysqli_fetch_array($res_ad))
				{
				?>

			   <a href="Videoplayer.html?file=content/videos/Skin_Video/<?php echo $row_ad['videofile'];?>">
                    <div style="height: 60%; width: 100%; color: #900; border: solid; background-color: #fff; border-color: #c8b2cb; border-radius: 9px; position: relative; float: left; margin: 1% 1% 3% 3%; max-width: 500px;">
                        <div>
                            ...
                            <span style='display: none;'>content/Images/Skin Care/<?php echo $row_ad['thumbnail'];?></span>
                        </div>
