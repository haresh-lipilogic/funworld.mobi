...
$clickid=$_COOKIE["vodacom_beautytips_act"];
  ...
  <div class="toplinks">
    ...
    <!-- <li><a href="../vd/cancel.php?serviceid=3&clickid=<?php// echo $clickid; ?>">Unsubscribe </a></li>-->
      <li><a href="https://funworld.mobi/vd2stag/bttnc.html">terms and conditions</a></li>
    </ul>
  </div>
</div>
</body>
