...
<img onclick="myFunction()" class="dropbtn" src="icon_menu.png">
  ...
  <div id="myDropdown" class="dropdown-content">
    ...
    <a href="<?php echo $actual_link;?>">Conseils</a>
    <a href="videos_fr.php">Vidéos</a>
    
  </div><a href='index_fr.php'><img  src="image/logo.png" width="173" height="58" class="logosvg"></a>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel"> 
  ...
  <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <span class="sr-only">Précédente</span> </a> <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next"> <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> <span class="sr-only">Suivante</span> </a> </div>
...
?>
					...
					<a href="category.php?id=<?php echo $row['id'];?>">
					<label style=" font-size: 15px;color:#900"><?php echo $row['title_fr'];?></label>
					</a>
					</td>
...
<!--<div class="footer">
  <div class="toplinks">
    <ul>
     ...
     <li><a href="http://club.funzone.mobi/vodacom/cancel.php?serviceid=1&clickid=<?php echo $clickid; ?>">Unsubscribe </a></li>
