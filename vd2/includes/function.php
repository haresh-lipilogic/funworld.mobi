...
$url = 'https://apix.vodacom.co.za/oauth-framework/generateaccesstoken';
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://apix.vodacom.co.za/oauth-framework/generateaccesstoken',
...
$url='https://apix.vodacom.co.za/v1/productofferingmanagement/getServiceEligibility';
...
include "dbdetail.php";
$date=date("Y-m-d H:i:s");
$redurl="https://funworld.mobi/vd2/redirect.php?clickid=$clickid";
...
$url='https://apix.vodacom.co.za/v1/productofferingmanagement/productOfferingQualification';
curl_setopt_array($curl, array(
  CURLOPT_URL => $url,
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
