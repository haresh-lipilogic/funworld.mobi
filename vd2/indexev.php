...
$packageid=$aar1['relatedParty'][0]['id'];
	...
	$url6=urlencode($redurl);
	$redurl="echeck.php?clickid=$clickid&kt=$url6&serviceid=$serviceid";
...
if($serviceid==1)
{
	...
	$tandc="https://funworld.mobi/vd2/wfhtnc.html";
}
else if($serviceid==2)
{
	$name="Fitness Tips";
	...
	$description2="Service with First Day Free From the Second day you will Charged R7/Day Subscription.";
	$tandc="https://funworld.mobi/vd2/fttnc.html";
}
else if($serviceid==3)
{
	$name="Beauty Tips";
	...
	$description2="Service with First Day Free From the Second day you will Charged R5/Day Subscription.";
	$tandc="https://funworld.mobi/vd2/bttnc.html";
}
else{
	...
	$description2="Service with First Day Free From the Second day you will Charged R7/Day Subscription.";
	$tandc="https://funworld.mobi/vd2/gametnc.html";
...
<!DOCTYPE html> <html>     <head>         <meta name="viewport" content="width=device-width">        
			...
			<div id="LogoDiv">            
			<a><img src="<?php echo $lpimage;?>" style="width:100%;max-height: 500px;"></a>         
			</div>         
