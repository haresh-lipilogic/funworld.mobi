...
?>
				<div class="container">
				  <div class="categoryrow">
					...
					<a href="http://glamourworld.me/videocontent/images/gallary/rgkvideos/<?php echo $row['filename'];?>"><!-- style="pointer-events: none;">-->
					...
					<img style="width:100%;height:260px" src="http://glamourworld.me/videocontent/images/gallary/thumb/<?php echo $row['thumbfile'];?>"></div><center><div><h4><?php echo $row['itemdescription'];?></h4></div></center>
					</div></a>
					<?php
					}
					else{
					...
					?>
						...
						<a href="http://glamourworld.me/videocontent/images/gallary/thumb/<?php echo $row['thumbfile'];?> "><!-- style="pointer-events: none;">-->
					...
					<img style="width:100%;height:180px" src="http://glamourworld.me/videocontent/images/gallary/thumb/<?php echo $row['thumbfile'];?>"></div><center><div><h4><?php echo $row['itemdescription'];?></h4></div></center>
					</div></a>
