...
<div class="navbar-wrapper">
  <nav class="navbar navbar-inverse navbar-static-top">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"><img src="image/logo.png" alt="" title="" style="height:50px ;width:40%"></a> </div>
...
?>
				   ...
				   <h5> <a href="category.php?id=<?php echo $id+1;?>">Next</a></h5>
				  </div>
