...
mysqli_set_charset($conn1,"utf8");
 ...
 if(isset($_GET['id']))
 {
	 ...
	 header("location:index_arab.php");
	 exit;
...
if (isset($_GET['p']))
{
	$p=$_GET['p'];
	$p=$p+12;
	$actual_link="index_arab.php?p=$p";
}
...
<div class="navbar-wrapper">
  <nav class="navbar navbar-inverse navbar-static-top">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index_arab.php"><img src="image/logo.png" alt="" title="" style="height:50px ;width:40%"></a> </div>
...
?>
					...
					foreach ($conn1->query($sql1) as $row) {
						$title=$row['title_arab'];
						$image=$row['image'];
						$description=$row['description_arab'];
				   ...
				   <h5> <a href="category_arab.php?id=<?php echo $id+1;?>">Next</a></h5>
				  </div>
