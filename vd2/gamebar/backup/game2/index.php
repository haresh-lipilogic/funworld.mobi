...
<!-- /.carousel -->
			<div class="container">
				  <div class="categoryrow">
					<h5>action game <a href="category.php?category=1">See more</a></h5>
					<div class="list-row">
					<?php 
					$res_banner='';
					...
					foreach ($conn->query($sql1) as $row) {
						?>
						 <a href="<?php echo "../hgame/".$row['filename']; ?>"><div class="listblock">
						<div class="list-img"><img src="<?php echo "../hgame/".$row['medianame']; ?>" alt="" title=""></div>
				  ...
				  <div class="categoryrow">
					<h5>adventure game<a href="category.php?category=2">See more</a></h5>
					<div class="list-row">
					<?php 
					$sql1="call htmlgames.GetGames(0,3);";
					foreach ($conn->query($sql1) as $row) {
				  ...
				  <div class="categoryrow">
					<h5>arcade game <a href="category.php?category=3">See more</a></h5>
					<div class="list-row">
					<?php 
					$sql1="call htmlgames.GetGames(0,3);";
					foreach ($conn->query($sql1) as $row) {
				   ...
				   <div class="categoryrow">
					<h5>board game <a href="category.php?category=4">See more</a></h5>
					<div class="list-row">
					<?php 
					$sql1="call htmlgames.GetGames(0,3);";
					foreach ($conn->query($sql1) as $row) {
