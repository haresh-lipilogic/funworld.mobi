...
?>
		...
		<a href="<?php echo "../hgame/".$row["filename"]; ?>" ><!-- style="pointer-events: none;">-->
		...
		<img style="width:100%;height:120px" src="<?php  echo "../hgame/".$row['medianame']; ?>"></div><center><div><h4><?php echo $row['productname'];?></h4></div></center>
		</div></a>
		<?php
		}
		?>
