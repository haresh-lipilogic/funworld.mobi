...
<div class="aspNetHidden">
        ...
        <div class="container">
            ...
            <div class="container">
                <div style="text-align: center;">
                    ...
                    <h2>Enter Number to Play Contest:</h2>
                    <input name="txtnumber" type="text" value="<?php echo $mobile; ?>" maxlength="10" id="txtnumber" placeholder="XXXXXXXXXX" style="height: 40px; width: 300px;"><br>
                    <br>
                    ...
                    <div class="subscribebtn">
                        <a id="btnRelease" class="landingsubscribe One" href="javascript:__doPostBack('btnRelease','')">Lets Play</a>
                    </div>
       ...
       <?php include 'footer.php';?>
        ...
        <div class="copyright">© 2020 ContestBazaar</div>
    </form>
