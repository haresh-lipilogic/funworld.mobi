...
//echo "INSERT INTO ".$db.".subscriber(clickid,mobile,accesstime,email) VALUES ('$clickid', '$mobile','$date','$email')";exit; 	
...
<div class="aspNetHidden">
	...
	<input type="hidden" name="mobile" id="mobile" value="<?php echo $mobile; ?>" />
        ...
        <div class="container">
            ...
            <br />
            <h1 class="txtBlue txtBold">Please select Questions Package</h1>

            <ul class="PlanLinks">
                <li id="firstli">
                    <a id="LinkButton3" href="javascript:__doPostBack('99','99')">
            99 Questions Plan @ <i class="fa fa-rupee"></i>  99/- only (First Time User only)</a>
                </li>
                <li>
