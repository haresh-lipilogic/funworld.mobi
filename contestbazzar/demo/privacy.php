...
<head id="Head1"><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no" /><title>
	:: Contest Bazaar ::
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="VwEsbIBEWNyaT7Frwv6FLx166A2rbTPw4LoHNiC+xHPmYxfeewc7L4vCYphoXvIZJk4cQhQqBsq/yheLFxLLjuU5014=" />
</div>
...
<script src="/WebResource.axd?d=pynGkmcFUV13He1Qd6_TZN8nq5YOYUeEyESpc8cbL612sOEIWHGgDh3x-Ip7bEEJoH5Cqg2&amp;t=637230637455078770" type="text/javascript"></script>
...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="BC85D02E" />
</div>
        <div class="container">
            <div class="header">
...
//]]>
            ...
            <div class="unsubdialog">
                <br />

                <p style="font-size: xx-large"><b>Privacy Policy</b></p>

                <p style="font-size: larger; border-top: 1px solid black; line-height: 20px">
                    <br />
                    The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to Sanvir Digitech Private Limited. and the terms "You" /"Your" / "Yourself" refer to the users.   
                </p>
                <p style="font-size: larger; line-height: 20px">
                    This Privacy Policy is an electronic record in the form of an electronic contract formed under the information Technology Act, 2000 and the rules made thereunder and the amended provisions pertaining to electronic documents / records in various statutes as amended by the information Technology Act, 2000. This Privacy Policy does not require any physical, electronic or digital signature.
                </p>
                <p style="font-size: larger; line-height: 20px">
                    This Privacy Policy is a legally binding document between you and Sanvir Digitech Private Limited. (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and Sanvir Digitech Private Limited. for your use of the website “Website” (defined below).
                </p>
                <p style="font-size: larger; line-height: 20px">
                ...
                <br />
                <p style="font-size: large"><b>USER INFORMATION</b></p>
                <p style="font-size: larger; line-height: 20px">
                ...
                <p style="font-size: large"><b>COOKIES</b></p>
                <p style="font-size: larger; line-height: 20px">
                ...
                <p style="font-size: large"><b>LINKS TO THE OTHER SITES</b></p>
                <p style="font-size: larger; line-height: 20px">
                ...
                <p style="font-size: large"><b>INFORMATION SHARING</b></p>
                <p style="font-size: larger; line-height: 20px">
                ...
                <p style="font-size: larger; line-height: 20px">
                    <b>(b)</b> We proposes to share such information within its group companies and officers and employees of such group companies for the purpose of processing personal information on its behalf. We also ensure that these recipients of such information agree to process such information based on our instructions and in compliance with this Privacy Policy and any other appropriate confidentiality and security measures.
                </p>
                <p style="font-size: large"><b>INFORMATION SECURITY</b></p>
                <p style="font-size: larger; line-height: 20px">
                ...
                <p style="font-size: large"><b>Grievance Redressal</b></p>
                <p style="font-size: larger; line-height: 20px">
                ...
                <p style="font-size: larger; line-height: 20px">
                    Mr. Ketan Patel <b>(Grievance Officer)</b>
                </p>
                <p>
                    Company Name & Address Sanvir Digitech Private Limited, Block No 607, Ekta Colony, Sector 27, Gandhinagar 382028, Gujarat
                </p>
                <p>
                    Email:
            <a href="mailto:support@svmobi.com" class="a">support@svmobi.com</a>
