...
if (isset($_GET['p']))
{
	$p=$_GET['p'];
	$p=$p+12;
	$actual_link="thesis_arab.php?p=$p";
}
...
<title>مرحبا بكم في العالم</title>
...
<img onclick="myFunction()" class="dropbtn" src="icon_menu.png">
  ...
  <div id="myDropdown" class="dropdown-content">
    <a href="index_arab.php">الصفحة الرئيسية</a>
    <a href="<?php echo $actual_link;?>">نصائح</a>
    <a href="videos_arab.php">أشرطة فيديو</a>
    
  </div><a href='index_arab.php'><img  src="image/logo.png" width="173" height="58" class="logosvg"></a>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel"> 
  ...
  <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev"> <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <span class="sr-only">سابق</span> </a> <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next"> <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> <span class="sr-only">التالى</span> </a> </div>
...
?>
					...
					<td  scope="row"style="max-width=70%;border-left: 2px solid #900;border-top: 3px solid #900;border-bottom: 2px solid #900;padding-top: 10px ;padding-left: 10px ;padding-bottom: 10px ;text-align: center;"> 
					<a href="category_arab.php?id=<?php echo $row['id'];?>">
					<img  src="image2/<?php echo $row['image'];?>" style="max-width:180px;">
					</a>
					</td>
					
					
					<td scope="row" style="max-width=70%;border-right: 2px solid #900;border-top: 3px solid #900;border-bottom: 2px solid #900;padding-top: 10px ;padding-right: 10px ;padding-bottom: 10px ;text-align: center;">
					<a href="category.php?id=<?php echo $row['id'];?>">
					<label style=" font-size: 15px;color:#900"><?php echo $row['title_arab'];?></label>
					</a>
					</td>
				   ...
				   <h5> <a href="<?php echo $actual_link;?>">أكثر من</a></h5>
				  </div>
...
<div class="footer">
  <div class="toplinks">
    <ul>
     ...
     <li><a href="http://funworld.mobi/vodacom/cancel.php?serviceid=1&clickid=<?php //echo $clickid; ?>">Unsubscribe </a></li>
