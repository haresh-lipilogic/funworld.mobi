...
<body style="color:#FFF ;background:#003; font-size:10px ;font-family: font128281;">
...
<img onclick="myFunction()" class="dropbtn" src="icon_menu.png">
  ...
  </div><a href="index.php"><img  src="http://club.funzone.mobi/portugal/image/gamebar.png" width="173" height="58" class="logosvg"></a>
</div>
</div>      
...
$sql1="call gamebardb.getproductlist(".$_GET['category'].");";
...
<img style="width:100%;height:140px" src="http://gamezzone.me/mediafiles/<?php echo $row['productcode']."_".$row['medianame'];?>"></div><center><div><h2><?php echo $row['productname'];?></h2>
