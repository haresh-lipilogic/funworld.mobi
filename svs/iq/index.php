...
$(document).ready(function(){
  $(".hide").click(function(){
	...
	var merchantname =  '<?php echo $merchantname; ?>';
		...
		window.location.href = "http://korek-he.heliveservices.com/iq-dcb/HE/v1.2/oneclick/sub.php?serviceId="+<?php echo $serviceid; ?> + "&spId=" +<?php echo $spid; ?> +"&shortcode="+ <?php echo $shortcode; ?> +"&ti="+<?php echo $clickid; ?> +"&ts=" +ts + "&servicename="+ servicename +"&merchantname="+ merchantname +"&type=he";
