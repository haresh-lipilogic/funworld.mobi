...
$msisdn=$_GET['msisdn'];
	...
	$url="https://vms.korektel.com:8443/dcb/API/VMS-DCBSubscription/actions/unsubscribeUser?user=GameStation&password=Game20Station24&msisdn=$msisdn&shortcode=3999&serviceId=45528&spId=13"; 
			...
			<div class="container">
				...
				<br>
					<center><p style="color:#fff;font-size:25px;">Error : <?php echo $data['msg'];   ?> | Your unsubscription request for <strong>GameStation</strong> has not been accepted.  </p></center>
						...
						<center><p style="color:#fff;font-size:25px;">Back to Content <a href="https://funworld.mobi/svs/iq/content/index?msisdn=$msisdn"> CLICK HERE </a> </p></center>
