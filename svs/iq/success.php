...
<body>
	...
	?>
		...
		<center><p style="font-size: 25px;color: #fff;">For Content Access, <a href="http://funworld.mobi/svs/iq/content/index?msisdn=<?php echo $msisdn; ?>" style="font-size: 25px;color: #fff;">Click Here</a></p> </center>
	<?php
	}
	else{
	?>
