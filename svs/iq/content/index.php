                    ...
                    <div class="banner-slider">
                        <center>                     
                             <a href="<?php echo "dl.php?ir=".$result[35]['id'];?>"><img class="cost30"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[35]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[34]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[34]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[33]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[33]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[32]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[32]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[31]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[31]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[30]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[30]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[29]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[29]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[28]['id'];?>"><img class="nocost30"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[28]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[27]['id'];?>"><img class="nocost9"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[27]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[26]['id'];?>"><img class="nocost91"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[26]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[25]['id'];?>"><img class="nocost93"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[25]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[24]['id'];?>"><img class="nocost913"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[24]['medianame'];?>"></a>                         
                        </center>
                    ...
                    <div class="banner-slider">
                        <center>                     
							<a href="<?php echo "dl.php?ir=".$result[12]['id'];?>"><img class="cost30"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[12]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[13]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[13]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[14]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[14]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[15]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[15]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[16]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[16]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[17]['id'];?>"><img class="cost9"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[17]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[18]['id'];?>"><img class="cost91"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[18]['medianame'];?>"></a>

                            <a href="<?php echo "dl.php?ir=".$result[19]['id'];?>"><img class="nocost30"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[19]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[20]['id'];?>"><img class="nocost9"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[20]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[21]['id'];?>"><img class="nocost91"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[21]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[22]['id'];?>"><img class="nocost93"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[22]['medianame'];?>"></a>
                            <a href="<?php echo "dl.php?ir=".$result[23]['id'];?>"><img class="nocost913"
                                    src="<?php echo "https://lkjgf.xyz/hgame/".$result[23]['medianame'];?>"></a>
                        </center>
