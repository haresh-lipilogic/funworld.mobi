...
<head>
    ...
    <title>Welcome to - Play Cool Game</title>
    ...
    <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php"><img src="assets/img/logo3.png" style="width:100%"></a>
...
?>
        ...
        <div class="game-section">
            <section class="container-fluid mb-3">
				...
				<?php foreach ($conn->query($sql1) as $row) {?>
                    ...
                    <div class="col"> <a  href="<?php echo "dl.php?ir=".$row['id'];?>"><img  src="<?php echo "https://lkjgf.xyz/hgame/".$row['medianame'];?>"></a>
                    </div>
    ...
    <footer>
        <div class="container">
            <p class="text-center">&copy; 2022 PlayCool &middot; <a href="privacy.html">Privacy</a> &middot; <a
