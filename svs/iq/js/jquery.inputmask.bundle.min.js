  ...
  function (e, t, n) {
    ...
    (o = function (e, t, n, i) {
      ...
      function u(t, n, a) {
        ...
        (this.el = i),
          ...
          !0 !== a &&
            ...
            c(this.opts.alias, n, this.opts));
      }
      function c(t, n, a) {
        var r = u.prototype.aliases[t];
        return r
          ? (r.alias && c(r.alias, i, a),
            e.extend(!0, a, r),
            e.extend(!0, a, n),
            !0)
        ...
        function a(t, a, r) {
          ...
          var l,
            c = o
              ...
              : t;
          return (
            u.prototype.masksCache[c] === i || !0 === n
              ? ((l = {
                  mask: t,
          ...
          if (t.mask.length > 1) {
            ...
            return (
              e.each(t.isRTL ? t.mask.reverse() : t.mask, function (n, a) {
                o.length > 1 &&
                  (o +=
                    t.groupmarker[1] + t.alternatormarker + t.groupmarker[0]),
      ...
      function m(a, c, p) {
        ...
        function w(e, t, n, a, r) {
          ...
          do {
            if (!0 === e && M().validPositions[f])
              (l = (u =
                r &&
                !0 === M().validPositions[f].match.optionality &&
                M().validPositions[f + 1] === i &&
                (!0 === M().validPositions[f].generatedInput ||
                  (M().validPositions[f].input == p.skipOptionalPartCharacter &&
                    f > 0))
                  ? F(f, G(f, s, f - 1))
                  : M().validPositions[f]).match),
                (s = u.locator.slice()),
                c.push(!0 === n ? u.input : !1 === n ? l.nativeDef : Z(f, l));
            else {
              (l = (u = T(f, s, f - 1)).match), (s = u.locator.slice());
              var d = !0 !== a && (!1 !== p.jitMasking ? p.jitMasking : l.jit);
              !1 === d ||
              d === i ||
              f < m ||
              ("number" == typeof d && isFinite(d) && d > f)
                ? c.push(!1 === n ? l.nativeDef : Z(f, l))
                : l.jit && l.optionalQuantifier !== i && ((k = f), E++);
            }
            "auto" === p.keepStatic &&
              l.newBlockMarker &&
              null !== l.fn &&
            ...
            ((g === i || f < g) && (null !== l.fn || "" !== l.def)) ||
            t > f
          );
          return (
            "" === c[c.length - 1] && c.pop(),
            (!1 === n && M().maskLength !== i) || (M().maskLength = f - 1),
            (p.greedy = o),
            c
          );
        }
        ...
        function j(e, t) {
          var n = (e.alternation != i ? e.mloc[_(e)] : e.locator).join("");
          if ("" !== n) for (; n.length < t; ) n += "0";
          return n;
        }
        function F(e, t) {
          for (
            var n, a, r, o = j(R((e = e > 0 ? e - 1 : 0))), s = 0;
            s < t.length;
            s++
          ) {
            var l = t[s];
        ...
        function T(e, t, n) {
          return M().validPositions[e] || F(e, G(e, t ? t.slice() : t, n));
        }
        function R(e, t) {
          return M().validPositions[e] ? M().validPositions[e] : (t || G(e))[0];
        }
        function N(e, t) {
        ...
        function G(t, n, a) {
          ...
          function g(n, a, o, s) {
            function l(o, s, u) {
              ...
              function k(e, t) {
                ...
                return p.regex && null !== e.match.fn && null !== t.match.fn
                  ? -1 !==
              ...
              if (c === t && o.matches === i)
                return (
                  m.push({ match: o, locator: s.reverse(), cd: h, mloc: {} }),
                  !0
                );
              if (o.matches !== i) {
                if (o.isGroup && u !== o) {
                  if ((o = l(n.matches[e.inArray(o, n.matches) + 1], s, u)))
                    return !0;
                  ...
                  if (-1 === E || "string" == typeof E) {
                    ...
                    if (M().excludes[t]) {
                      for (
                        var j = _.slice(), F = 0, T = M().excludes[t].length;
                        F < T;
                        F++
                      )
                    ...
                    for (var R = !1, N = 0; N < _.length; N++) {
                      (w = parseInt(_[N])),
                        (m = []),
                        (a = ("string" == typeof E && v(c, w, C)) || O.slice()),
                        P.matches[w] && l(P.matches[w], [w].concat(s), u)
                          ? (o = !0)
                          : 0 === N && (R = !0),
                        (x = m.slice()),
                        (c = D),
                        ...
                        for (var L = 0; L < S.length; L++) {
                          ...
                          if (
                            ...
                            if (
                              ...
                              null === (z = I).match.fn &&
                                null !== q.match.fn &&
                                q.match.fn.test(z.match.def, M(), t, !1, p, !1))
                            ) {
                              y(I, H) &&
                                ((B = !0), S.splice(S.indexOf(H), 0, I));
                              break;
                  ...
                  o.isQuantifier &&
                  u !== n.matches[e.inArray(o, n.matches) - 1]
                )
                  for (
                    var V = o, K = a.length > 0 ? a.shift() : 0;
                    K < (isNaN(V.quantifier.max) ? K + 1 : V.quantifier.max) &&
                    c <= t;
                    K++
                  ) {
                    ...
                    if ((o = l(U, [K].concat(s), U))) {
                      if (
                        (((r = m[m.length - 1].match).optionalQuantifier =
                          K > V.quantifier.min - 1),
                        (r.jit = K + U.matches.indexOf(r) >= V.quantifier.jit),
                        f(r, U) && K > V.quantifier.min - 1)
                      ) {
                        (d = !0), (c = t);
                        break;
                      }
          ...
          if (t > -1) {
            if (n === i) {
              for (
                var v, k = t - 1;
                (v = M().validPositions[k] || M().tests[k]) === i && k > -1;
              ...
              v !== i &&
                ...
                s.length > 0 &&
                  (s[0].alternation === i
                    ? 0 === (l = F(o, s.slice()).locator.slice()).length &&
                      (l = s[0].locator.slice())
                        ...
                        if ("" !== t.def)
                          if (0 === l.length) l = t.locator.slice();
                            ...
                            for (var n = 0; n < l.length; n++)
                              t.locator[n] &&
                                -1 === l[n].toString().indexOf(t.locator[n]) &&
                                (l[n] += "," + t.locator[n]);
                      })),
                (h = (f = l).join("")),
                (c = k));
          ...
          return (
            ...
            n !== i && M().tests[t]
              ? e.extend(!0, [], m)
              : ((M().tests[t] = e.extend(!0, [], m)), M().tests[t])
          );
        }
        function I() {
          return (
        ...
        function B(e) {
          return (
            (M().buffer !== i && !0 !== e) || (M().buffer = w(!0, O(), !0)),
            M().buffer
          );
        }
        function L(e, t, n) {
          ...
          for (r = e, a = e; a < t; a++)
            if ((D(!0), n[a] !== p.skipOptionalPartCharacter)) {
              var o = K(r, n[a], !0, !0);
        ...
        function V(t, n, a, r, o) {
          var s,
            ...
            h = !1,
            g = o !== i ? o : O();
          if (-1 === g && o === i) l = (c = R((s = 0))).alternation;
          else
            for (; g >= 0; g--)
          ...
          if (l !== i) {
            (m = parseInt(s)),
              (M().excludes[m] = M().excludes[m] || []),
              !0 !== t && M().excludes[m].push(_(c));
            var v = [],
              k = 0;
            for (p = m; p < O(i, !0) + 1; p++)
              (f = M().validPositions[p]) && !0 !== f.generatedInput
                ? v.push(f.input)
                : p < t && k++,
            ...
            for (; M().excludes[m] && M().excludes[m].length < 10; ) {
              var y = -1 * k,
                b = v.slice();
              for (M().tests[m] = i, D(!0), h = !0; b.length > 0; ) {
                var x = b.shift();
                if (!(h = K(O(i, !0) + 1, x, !1, r, !0))) break;
              }
              if (h && n !== i) {
                var P = O(t) + 1;
                for (p = m; p < O() + 1; p++)
                  ((f = M().validPositions[p]) === i || null == f.match.fn) &&
                    p < t + y &&
                    y++;
                h = K((t += y) > P ? P : t, n, a, r, !0);
              }
              if (h) break;
              if (
                (D(),
        ...
        function K(t, n, a, r, o, s) {
          ...
          function f(n, a, o) {
            var s = !1;
            return (
              e.each(G(n + (n == k ? E : 0)), function (c, f) {
                var m = f.match;
                if (
                  (B(!0),
                  !1 !==
                    (s =
                      null != m.fn
                        ? m.fn.test(a, M(), n, o, p, l(t))
                        : (a === m.def || a === p.skipOptionalPartCharacter) &&
                          "" !== m.def && { c: Z(n, m, !0) || m.def, pos: n }))
                ) {
                  var d = s.c !== i ? s.c : a,
                    h = n;
                  return (
                    (d =
                      d === p.skipOptionalPartCharacter && null === m.fn
                        ? Z(n, m, !0) || m.def
                        : d),
                    s.remove !== i &&
                              ...
                              switch (p.casing || n.casing) {
                                ...
                                case "title":
                                  ...
                                  t =
                                    ...
                                    (a &&
                                      a.input ===
                                        String.fromCharCode(u.keyCode.SPACE))
                                      ? t.toUpperCase()
                                      : t.toLowerCase();
                                  break;
                                default:
                                  if (e.isFunction(p.casing)) {
                                    ...
                                    r.push(M().validPositions),
                                      (t = p.casing.apply(this, r));
                                  }
                              }
                              return t;
                            })(d, m, h),
          ...
          var m = !0,
            d = e.extend(!0, {}, M().validPositions);
          if (
            (e.isFunction(p.preValidation) &&
              !a &&
              !0 !== r &&
              !0 !== s &&
              (m = p.preValidation(B(), c, n, l(t), p, M())),
            !0 === m)
          ) {
            if (
              (U(i, c, !0),
              (g === i || c < g) &&
                ((m = f(c, n, a)), (!a || !0 === r) && !1 === m && !0 !== s))
            ) {
              var h = M().validPositions[c];
              if (
                !h ||
                null !== h.match.fn ||
                (h.match.def !== n && n !== p.skipOptionalPartCharacter)
              ) {
                if (
                  (p.insertMode || M().validPositions[Q(c)] === i) &&
                  !q(c, !0)
                )
                  for (var v = c + 1, y = Q(c); v <= y; v++)
                    if (!1 !== (m = f(v, n, a))) {
          ...
          if (
            e.isFunction(p.postValidation) &&
            !1 !== m &&
            !a &&
            !0 !== r &&
            !0 !== s
          ) {
            var b = p.postValidation(B(!0), m, p);
            if (b !== i) {
              if (b.refreshFromBuffer && b.buffer) {
                var P = b.refreshFromBuffer;
                L(!0 === P ? P : P.start, P.end, b.buffer);
              }
              m = !0 === b ? m : b;
            }
          }
        ...
        function U(t, n, a) {
          ...
          for (var o = t; o < n; o++) {
            if (M().validPositions[o] === i && !q(o, !0))
              if (0 == o ? R(o) : M().validPositions[o - 1]) {
                var s = G(o).slice();
                ...
                if (
                  ...
                  var u = M().validPositions[n].input;
                  (M().validPositions[n] = i), (r = K(n, u, !0, !0));
                }
              }
          }
          return r;
        ...
        function z(t, n, a, r) {
          ...
          if (
            ...
            (r = r !== i ? r : s),
            s !== l || (p.insertMode && M().validPositions[r] !== i && a === i))
          ) {
            var u = e.extend(!0, {}, M().validPositions),
              c = O(i, !0);
            for (M().p = s, g = c; g >= s; g--)
              M().validPositions[g] &&
                "+" === M().validPositions[g].match.nativeDef &&
                (p.isNegative = !1),
                delete M().validPositions[g];
            var f = !0,
              m = r,
              d = (M().validPositions, !1),
              h = m,
              g = m;
            for (
              n &&
              ((M().validPositions[r] = e.extend(!0, {}, n)),
              h++,
              m++,
              s < l && g++);
              g <= c;
              ...
              if (
                ...
                for (; "" !== R(h).match.def; ) {
                  if (
                    !1 === d &&
                    u[h] &&
                    u[h].match.nativeDef === v.match.nativeDef
                  )
                    (M().validPositions[h] = e.extend(!0, {}, u[h])),
                      (M().validPositions[h].input = v.input),
                      U(i, h, !0),
                      (m = h + 1),
                      (f = !0);
                  else if (N(h, v.match.def)) {
                    var k = K(h, v.input, !0, !0);
                    (f = !1 !== k),
                      (m = k.caret || k.insert ? O() : h + 1),
                      (d = !0);
                  } else if (
                    !(f =
                      !0 === v.generatedInput ||
                      (v.input === p.radixPoint && !0 === p.numericInput)) &&
                    "" === R(h).match.def
                  )
                    break;
                  if (f) break;
                ...
                "" == R(h).match.def && (f = !1), (h = m);
              }
              if (!f) break;
            }
            if (!f)
              return (M().validPositions = e.extend(!0, {}, u)), D(!0), !1;
          } else n && (M().validPositions[r] = e.extend(!0, {}, n));
          return D(!0), !0;
        }
        function q(e, t) {
          var n = T(e).match;
          if (("" === n.def && (n = R(e).match), null != n.fn)) return n.fn;
          if (!0 !== t && e > -1) {
            var i = G(e);
        ...
        function Q(e, t) {
          for (
            var n = e + 1;
            "" !== R(n).match.def &&
            ((!0 === t && (!0 !== R(n).match.newBlockMarker || !q(n))) ||
              (!0 !== t && !q(n)));
        ...
        function W(e, t) {
          ...
          for (
            ;
            --i > 0 &&
            ((!0 === t && !0 !== R(i).match.newBlockMarker) ||
              (!0 !== t &&
                !q(i) &&
                ((n = G(i)).length < 2 ||
        ...
        function $(t, n, a, r, o) {
          if (r && e.isFunction(p.onBeforeWrite)) {
            var s = p.onBeforeWrite.call(y, r, n, a, p);
            if (s) {
              if (s.refreshFromBuffer) {
                var l = s.refreshFromBuffer;
                L(!0 === l ? l : l.start, l.end, s.buffer || n), (n = B(!0));
              }
          ...
          if (
            ...
            (S = !0),
              ...
              setTimeout(function () {
                c === I().join("")
                  ? u.trigger("cleared")
                  : !0 === oe(n) && u.trigger("complete");
              }, 0);
          }
        }
        function Z(t, n, a) {
          if ((n = n || R(t).match).placeholder !== i || !0 === a)
              ...
              if (o.length > 1 + ("" === o[o.length - 1].match.def ? 1 : 0))
                for (var l = 0; l < o.length; l++)
                  if (
                    ...
                    (null === o[l].match.fn ||
                      r === i ||
                      !1 !== o[l].match.fn.test(r.match.def, M(), t, !0, p)) &&
                    (s.push(o[l]),
          ...
          Y = {
            on: function (t, n, a) {
                      ...
                      (n.readOnly &&
                        !(
                          ("keydown" === t.type &&
                            t.ctrlKey &&
                            67 === t.keyCode) ||
                          (!1 === p.tabThrough && t.keyCode === u.keyCode.TAB)
                        ))
                    )
                  ) {
                    switch (t.type) {
                      case "input":
                        ...
                        if (r) {
                          ...
                          return (
                            setTimeout(function () {
                              a.apply(n, c), ie(n, n.inputmask.caretPos, i, !0);
                            }, 0),
                            !1
                          );
                        }
                      ...
                      case "keydown":
                        ...
                        break;
                      case "keypress":
                        if (!0 === P) return t.preventDefault();
                        P = !0;
                        break;
                      case "click":
                        if (o || l) {
              ...
              (t.inputmask.events[n] = t.inputmask.events[n] || []),
                t.inputmask.events[n].push(s),
                -1 !== e.inArray(n, ["submit", "reset"])
                  ? null !== t.form && e(t.form).on(n, s)
                  : e(t).on(n, s);
            },
            off: function (t, n) {
              var i;
          ...
          X = {
            keydownEvent: function (t) {
              var n = this,
                ...
                r = ie(n);
              if (
                a === u.keyCode.BACKSPACE ||
                a === u.keyCode.DELETE ||
                (l && a === u.keyCode.BACKSPACE_SAFARI) ||
                (t.ctrlKey && a === u.keyCode.X && !f("cut"))
              )
                t.preventDefault(),
                  se(n, a, r),
                  $(
                    ...
                    M().p,
                    t,
                    n.inputmask._valueGet() !== B().join("")
                  );
              else if (a === u.keyCode.END || a === u.keyCode.PAGE_DOWN) {
                t.preventDefault();
                var o = Q(O());
                p.insertMode || o !== M().maskLength || t.shiftKey || o--,
                  ie(n, t.shiftKey ? r.begin : o, o, !0);
              } else
                (a === u.keyCode.HOME && !t.shiftKey) || a === u.keyCode.PAGE_UP
                  ? (t.preventDefault(), ie(n, 0, t.shiftKey ? r.begin : 0, !0))
                  : ((p.undoOnEscape && a === u.keyCode.ESCAPE) ||
                      (90 === a && t.ctrlKey)) &&
                    !0 !== t.altKey
                  ? (ee(n, !0, !1, d.split("")), i.trigger("click"))
                  : a !== u.keyCode.INSERT || t.shiftKey || t.ctrlKey
                  ? !0 === p.tabThrough && a === u.keyCode.TAB
                    ? (!0 === t.shiftKey
                        ? (null === R(r.begin).match.fn &&
                            (r.begin = Q(r.begin)),
                          (r.end = W(r.begin, !0)),
                          (r.begin = W(r.end, !0)))
                        : ((r.begin = Q(r.begin, !0)),
                          (r.end = Q(r.begin, !0)),
                          r.end < M().maskLength && r.end--),
                      r.begin < M().maskLength &&
                        (t.preventDefault(), ie(n, r.begin, r.end)))
                    : t.shiftKey ||
                      (!1 === p.insertMode &&
                        (a === u.keyCode.RIGHT
                          ? setTimeout(function () {
                          ...
                          : a === u.keyCode.LEFT &&
                            setTimeout(function () {
                              var e = ie(n);
                              ie(n, x ? e.begin + 1 : e.begin - 1);
                            }, 0)))
                  : ((p.insertMode = !p.insertMode),
                    ie(
                      n,
                      p.insertMode || r.begin !== M().maskLength
                        ? r.begin
                        : r.begin - 1
                    ));
              p.onKeyDown.call(this, t, B(), ie(n).begin, p),
                (A = -1 !== e.inArray(a, p.ignorables));
            },
            keypressEvent: function (t, n, a, r, o) {
              ...
              if (c) {
                46 === c &&
                  !1 === t.shiftKey &&
                  "" !== p.radixPoint &&
                  (c = p.radixPoint.charCodeAt(0));
                var f,
                  m = n ? { begin: o, end: o } : ie(s),
                  h = String.fromCharCode(c),
                  g = 0;
                if (p._radixDance && p.numericInput) {
                  var v = B().indexOf(p.radixPoint.charAt(0)) + 1;
                  m.begin <= v &&
                    (c === p.radixPoint.charCodeAt(0) && (g = 1),
                    (m.begin -= 1),
                    (m.end -= 1));
                }
                M().writeOutBuffer = !0;
                ...
                if (
                  (!1 !== k &&
                    ...
                    (f =
                      k.caret !== i
                        ? k.caret
                        : Q(k.pos.begin ? k.pos.begin : k.pos)),
                    (M().p = f)),
                  (f = (p.numericInput && k.caret === i ? W(f) : f) + g),
                  !1 !== a &&
                    (setTimeout(function () {
                      p.onKeyValidation.call(s, c, k, p);
                    }, 0),
                    M().writeOutBuffer && !1 !== k))
                ) {
                  var y = B();
                  $(s, y, f, t, !0 !== n);
                }
            ...
            pasteEvent: function (n) {
              ...
              if (
                (l === (x ? I().reverse() : I()).slice(0, s.begin).join("") &&
                  (l = ""),
                u === (x ? I().reverse() : I()).slice(s.end).join("") &&
                  (u = ""),
              ...
              if (e.isFunction(p.onBeforePaste)) {
                if (!1 === (c = p.onBeforePaste.call(y, o, p)))
                  return n.preventDefault();
                c || (c = o);
              }
              return (
                ee(a, !1, !1, c.toString().split("")),
                $(a, B(), Q(O()), n, d !== B().join("")),
                n.preventDefault()
              );
            },
            inputFallBackEvent: function (t) {
              ...
              if (B().join("") !== r) {
                ...
                if (
                  ((i = s),
                  "." === (n = r).charAt(i.begin - 1) &&
                    "" !== p.radixPoint &&
                    (((n = n.split(""))[i.begin - 1] = p.radixPoint.charAt(0)),
                    (n = n.join(""))),
                  (r = (function (e, t, n) {
                    if (o) {
                  ...
                  if (f !== d) {
                    for (
                      var y = (k = f.length >= d.length) ? f.length : d.length,
                        b = 0;
                      f.charAt(b) === d.charAt(b) && b < y;
                      b++
                    );
                  ...
                  if (
                      ...
                      (m.length > h.length
                        ...
                        : m.length < h.length &&
                          ...
                          k ||
                            "" === p.radixPoint ||
                            "" !== m ||
                            f.charAt(g.begin + c - 1) !== p.radixPoint ||
                            (g.begin--, (v = p.radixPoint)))),
                    $(a, B(), { begin: g.begin + c, end: g.end + c }),
                    v.length > 0)
                  )
                    e.each(v.split(""), function (t, n) {
                      var i = new e.Event("keypress");
                      (i.which = n.charCodeAt(0)),
                        (A = !1),
                        X.keypressEvent.call(a, i);
                    });
                  else {
                    g.begin === g.end - 1 &&
                      ((g.begin = W(g.begin + 1)),
                    ...
                    (x.keyCode = p.numericInput
                      ? u.keyCode.BACKSPACE
                      : u.keyCode.DELETE),
                      X.keydownEvent.call(a, x),
                      !1 === p.insertMode && ie(a, ie(a).begin - 1);
                  }
                  t.preventDefault();
                }
              }
                  ...
                  case "deleteContentBackward":
                    return (
                      ((i = new e.Event("keydown")).keyCode =
                        u.keyCode.BACKSPACE),
                      X.keydownEvent.call(n, i),
                      t.preventDefault()
                    );
                  case "deleteContentForward":
                    var i;
                    return (
                      ((i = new e.Event("keydown")).keyCode = u.keyCode.DELETE),
                      X.keydownEvent.call(n, i),
                      t.preventDefault()
                    );
                }
            ...
            setValueEvent: function (t) {
              ...
              e.isFunction(p.onBeforeMask) &&
                (n = p.onBeforeMask.call(y, n, p) || n),
                ee(this, !0, !1, (n = n.split(""))),
                (d = B().join("")),
                (p.clearMaskOnLostFocus || p.clearIncomplete) &&
                  this.inputmask._valueGet() === I().join("") &&
            ...
            focusEvent: function (e) {
              ...
              p.showMaskOnFocus &&
                (!p.showMaskOnHover || (p.showMaskOnHover && "" === n)) &&
                (t.inputmask._valueGet() !== B().join("")
                  ? $(t, B(), Q(O()))
                  : !1 === C && ie(t, Q(O()))),
                !0 === p.positionCaretOnTab &&
                  !1 === C &&
                  X.clickEvent.apply(t, [e, !0]),
                (d = B().join(""));
            },
            mouseleaveEvent: function (e) {
              if (
                ((C = !1), p.clearMaskOnLostFocus && n.activeElement !== this)
              ) {
                var t = B().slice(),
                    ...
                    switch (p.positionCaretOnClick) {
                        ...
                        if (
                          (function (t) {
                            if ("" !== p.radixPoint) {
                              ...
                              if (n[t] === i || n[t].input === Z(t)) {
                                if (t < Q(-1)) return !0;
                                var a = e.inArray(p.radixPoint, B());
                                if (-1 !== a) {
                                  for (var r in n)
                                    if (a < r && n[r].input !== Z(r)) return !1;
                                  return !0;
                                }
                              }
                            }
                      ...
                      default:
                        var s = t.begin,
                          l = O(s, !0),
                          u = Q(l);
                        if (s < u) ie(r, q(s, !0) || q(s - 1, !0) ? s : Q(s));
                        else {
                          var c = M().validPositions[l],
                            f = T(u, c ? c.match.locator : i, c),
                            m = Z(u, f.match);
                          if (
                            ("" !== m &&
                              B()[u] !== m &&
                            ...
                            (!q(u, p.keepStatic) && f.match.def === m)
                          ) {
                            var d = Q(u);
                            (s >= d || s === u) && (u = d);
                          }
            ...
            cutEvent: function (i) {
              ...
              var a = ie(this),
                ...
                s = x ? B().slice(a.end, a.begin) : B().slice(a.begin, a.end);
              o.setData("text", x ? s.reverse().join("") : s.join("")),
                n.execCommand && n.execCommand("copy"),
                se(this, u.keyCode.DELETE, a),
                $(this, B(), M().p, i, d !== B().join(""));
            },
              ...
              if (this.inputmask) {
                ...
                ("" === a && v === i) ||
                  ...
                  !1 === oe(r) &&
                    ...
                    p.clearIncomplete &&
                      (D(), (r = p.clearMaskOnLostFocus ? [] : I().slice()))),
                  $(this, r, i, t)),
                  d !== B().join("") && ((d = r.join("")), n.trigger("change"));
              }
            },
        ...
        function ee(t, n, a, r, o) {
          var s = this || t.inputmask,
            l = r.slice(),
            c = "",
            f = -1,
            m = i;
          if ((D(), a || !0 === p.autoUnmask)) f = Q(f);
          else {
            var d = I().slice(0, Q(-1)).join(""),
              h = l.join("").match(new RegExp("^" + u.escapeRegex(d), "g"));
            h && h.length > 0 && (l.splice(0, h.length * d.length), (f = Q(f)));
          }
          -1 === f ? ((M().p = Q(f)), (f = 0)) : (M().p = f),
            (s.caretPos = { begin: f }),
              ...
              if (r !== i)
                if (
                  ...
                  (p = f),
                    ...
                    q(p) ||
                    !(
                      R(p).match.nativeDef === d.charAt(0) ||
                      (null === R(p).match.fn &&
                        R(p).match.nativeDef === "'" + d.charAt(0)) ||
                      (" " === R(p).match.nativeDef &&
                        (R(p + 1).match.nativeDef === d.charAt(0) ||
                          (null === R(p + 1).match.fn &&
                            R(p + 1).match.nativeDef === "'" + d.charAt(0))))
                    )
                      ? (m = X.keypressEvent.call(
                          t,
                          o,
                          !0,
                          !1,
                          a,
                          s.caretPos.begin
                        )) && ((f = s.caretPos.begin + 1), (c = ""))
                      : (m = X.keypressEvent.call(t, o, !0, !1, a, u + 1)),
                    m &&
                      ($(i, B(), m.forwardPosition, o, !1),
                      (s.caretPos = {
        ...
        function te(t) {
          ...
          var o = 0 === n.length ? "" : (x ? n.reverse() : n).join("");
          if (e.isFunction(p.onUnMask)) {
            var s = (x ? B().slice().reverse() : B()).join("");
        ...
        function ne(e) {
          return (
            !x ||
              ...
              !b ||
              (e = b.inputmask._valueGet().length - e),
            e
          );
        }
        function ie(a, r, o, s) {
          ...
          if (r === i)
            return (
              ...
              { begin: s ? r : ne(r), end: s ? o : ne(o) }
            );
          if (
            (e.isArray(r) && ((o = x ? r[0] : r[1]), (r = x ? r[1] : r[0])),
            r.begin !== i &&
              ((o = x ? r.begin : r.end), (r = x ? r.end : r.begin)),
            "number" == typeof r)
          ) {
            (r = s ? r : ne(r)),
              (o = "number" == typeof (o = s ? o : ne(o)) ? o : r);
            var c =
              parseInt(
            ...
            if (
              ((a.scrollLeft = c > a.scrollWidth ? c : 0),
              l || !1 !== p.insertMode || r !== o || o++,
        ...
        function re(e) {
          e.length = 0;
          for (var t, n = w(!0, 0, !0, i, !0); (t = n.shift()) !== i; )
            e.push(t);
          return e;
        }
        function oe(t) {
        ...
        function se(e, t, n, a, r) {
          ...
          if (
            (t === u.keyCode.BACKSPACE &&
            (n.end - n.begin < 1 || !1 === p.insertMode)
              ? ((n.begin = W(n.begin)),
                M().validPositions[n.begin] !== i &&
                  M().validPositions[n.begin].input === p.groupSeparator &&
                  n.begin--,
                !1 === p.insertMode && n.end !== M().maskLength && n.end--)
              : t === u.keyCode.DELETE &&
                n.begin === n.end &&
                ((n.end =
                  q(n.end, !0) &&
                  M().validPositions[n.end] &&
                  M().validPositions[n.end].input !== p.radixPoint
                    ? n.end + 1
                    : Q(n.end) + 1),
                M().validPositions[n.begin] !== i &&
                  M().validPositions[n.begin].input === p.groupSeparator &&
                  n.end++),
            z(n),
            (!0 !== a && !1 !== p.keepStatic) || null !== p.regex)
          ) {
            var s = V(!0);
            if (s) {
              var l =
                s.caret !== i
                  ? s.caret
                  : s.pos
                  ? Q(s.pos.begin ? s.pos.begin : s.pos)
                  : O(-1, !0);
              (t !== u.keyCode.DELETE || n.begin > l) && n.begin;
            }
          }
          var c = O(n.begin, !0);
          if (c < n.begin || -1 === n.begin) M().p = Q(c);
              ...
              do {
                M().validPositions[c]
                  ...
                  : ((o = T(c, s, c - 1)),
                    ...
                    !1 === p.jitMasking ||
                    c < d ||
                    ("number" == typeof p.jitMasking &&
                      isFinite(p.jitMasking) &&
                      p.jitMasking > c)
                      ? f(Z(c, r))
                      : (u = !1)),
                  c++;
              } while (
                ((g === i || c < g) && (null !== r.fn || "" !== r.def)) ||
                d > c ||
                u
              );
              u && f(),
                n.activeElement === e &&
                  (l.splice(
                    t.begin,
                    0,
                    t.begin === t.end || t.end > M().maskLength
        ...
        if (
          ...
          switch (a.action) {
            ...
            case "unmaskedvalue":
              return (
                (b !== i && a.value === i) ||
                  ...
                  (J = (
                    (e.isFunction(p.onBeforeMask) &&
                      p.onBeforeMask.call(y, J, p)) ||
                    J
                  ).split("")),
                  ee.call(this, i, !1, !1, J),
                  e.isFunction(p.onBeforeWrite) &&
                    p.onBeforeWrite.call(y, i, B(), 0, p)),
                te(b)
              );
            case "mask":
              !(function (t) {
                ...
                if (
                  !1 !== a &&
                  ((h = e((b = t))),
                  -1 === (g = b !== i ? b.maxLength : i) && (g = i),
                  !0 === p.colorMask && le(b),
                  r &&
                    ("inputmode" in b &&
                      ((b.inputmode = p.inputmode),
                      b.setAttribute("inputmode", p.inputmode)),
                    !0 === p.disablePredictiveText &&
                      ("autocorrect" in b
                        ? (b.autocorrect = !1)
                        : (!0 !== p.colorMask && le(b),
                          (b.type = "password")))),
                  !0 === a &&
                    (Y.on(b, "submit", X.submitEvent),
                    Y.on(b, "reset", X.resetEvent),
                    Y.on(b, "blur", X.blurEvent),
                    Y.on(b, "focus", X.focusEvent),
                    !0 !== p.colorMask &&
                      (Y.on(b, "click", X.clickEvent),
                      Y.on(b, "mouseleave", X.mouseleaveEvent),
                      Y.on(b, "mouseenter", X.mouseenterEvent)),
                    Y.on(b, "dblclick", X.dblclickEvent),
                    Y.on(b, "paste", X.pasteEvent),
                    Y.on(b, "dragdrop", X.pasteEvent),
                    Y.on(b, "drop", X.pasteEvent),
                    Y.on(b, "cut", X.cutEvent),
                    Y.on(b, "complete", p.oncomplete),
                    Y.on(b, "incomplete", p.onincomplete),
                    Y.on(b, "cleared", p.oncleared),
                    r || !0 === p.inputEventOnly
                      ? b.removeAttribute("maxLength")
                      : (Y.on(b, "keydown", X.keydownEvent),
                        Y.on(b, "keypress", X.keypressEvent)),
                    Y.on(b, "compositionstart", e.noop),
                    Y.on(b, "compositionupdate", e.noop),
                    Y.on(b, "compositionend", e.noop),
                    Y.on(b, "keyup", e.noop),
                    Y.on(b, "input", X.inputFallBackEvent),
                    Y.on(b, "beforeinput", X.beforeInputEvent)),
                  Y.on(b, "setvalue", X.setValueEvent),
                  (d = I().join("")),
                  ...
                  var o =
                    (e.isFunction(p.onBeforeMask) &&
                      p.onBeforeMask.call(y, b.inputmask._valueGet(!0), p)) ||
                    b.inputmask._valueGet(!0);
                  "" !== o && ee(b, !0, !1, o.split(""));
                  var l = B().slice();
                  (d = l.join("")),
                    !1 === oe(l) && p.clearIncomplete && D(),
                    p.clearMaskOnLostFocus &&
                      n.activeElement !== b &&
                      (-1 === O() ? (l = []) : re(l)),
                    (!1 === p.clearMaskOnLostFocus ||
                      (p.showMaskOnFocus && n.activeElement === b) ||
                      "" !== b.inputmask._valueGet(!0)) &&
                      $(b, l),
                    n.activeElement === b && ie(b, Q(O()));
                }
              })(b);
              break;
            case "format":
              return (
                (J = (
                  (e.isFunction(p.onBeforeMask) &&
                    p.onBeforeMask.call(y, a.value, p)) ||
                  a.value
                ).split("")),
                ee.call(this, i, !0, !1, J),
                a.metadata
                  ? {
                      value: x ? B().slice().reverse().join("") : B().join(""),
            ...
            case "isValid":
              a.value
                ? ((J = a.value.split("")), ee.call(this, i, !0, !0, J))
                : (a.value = B().join(""));
              for (
                var ce = B(), pe = ae(), fe = ce.length - 1;
                fe > pe && !q(fe);
                fe--
              );
              return (
                ce.splice(pe, fe + 1 - pe), oe(ce) && a.value === B().join("")
              );
            case "getemptymask":
              return I().join("");
            case "remove":
              if (b && b.inputmask)
                e.data(b, "_inputmask_opts", null),
                  (h = e(b)),
                  b.inputmask._valueSet(
                    p.autoUnmask ? te(b) : b.inputmask._valueGet(!0)
                  ),
                  Y.off(b),
                  ...
                  Object.getOwnPropertyDescriptor && Object.getPrototypeOf
                    ...
                    : n.__lookupGetter__ &&
                      ...
                      b.inputmask.__valueGet &&
                      (b.__defineGetter__("value", b.inputmask.__valueGet),
                      b.__defineSetter__("value", b.inputmask.__valueSet)),
                  (b.inputmask = i);
              return b;
            case "getmetadata":
      ...
      return (
        (u.prototype = {
            ...
            return (
              ...
              e.each(a, function (n, a) {
                ...
                if (
                  ...
                  s !== i &&
                    (a.inputmask !== i &&
                      ((a.inputmask.opts.autoUnmask = !0),
                      a.inputmask.remove()),
                    (a.inputmask = new u(i, i, !0)),
                    (a.inputmask.opts = o),
                    ...
                    m.call(a.inputmask, { action: "mask" }));
                }
              }),
          ...
          unmaskedvalue: function (e) {
            return (
              (this.maskset = this.maskset || p(this.opts, this.noMasksCache)),
              m.call(this, { action: "unmaskedvalue", value: e })
            );
          },
          remove: function () {
          ...
          getemptymask: function () {
            return (
              (this.maskset = this.maskset || p(this.opts, this.noMasksCache)),
              m.call(this, { action: "getemptymask" })
            );
          },
          ...
          isComplete: function () {
            return (
              (this.maskset = this.maskset || p(this.opts, this.noMasksCache)),
              m.call(this, { action: "isComplete" })
            );
          },
          getmetadata: function () {
            return (
              (this.maskset = this.maskset || p(this.opts, this.noMasksCache)),
              m.call(this, { action: "getmetadata" })
            );
          },
          isValid: function (e) {
            return (
              (this.maskset = this.maskset || p(this.opts, this.noMasksCache)),
              m.call(this, { action: "isValid", value: e })
            );
          },
          format: function (e, t) {
            return (
              (this.maskset = this.maskset || p(this.opts, this.noMasksCache)),
              m.call(this, { action: "format", value: e, metadata: t })
            );
          },
          setValue: function (t) {
                ...
                switch (o.charAt(0)) {
                  ...
                  case a.groupmarker[1]:
                    if ((((s = g.pop()).openGroup = !1), s !== i))
                      if (g.length > 0) {
                        if (
                          ((l = g[g.length - 1]).matches.push(s),
                          l.isAlternator)
                        ) {
                          c = g.pop();
                          for (var P = 0; P < c.matches.length; P++)
                            (c.matches[P].isGroup = !1),
                              (c.matches[P].alternatorGroup = !1);
                          g.length > 0
                            ? (l = g[g.length - 1]).matches.push(c)
                            : h.matches.push(c);
                        }
                ...
                (!(function t(r) {
                  r &&
                    ...
                    e.each(r.matches, function (e, o) {
                      var s = r.matches[e + 1];
                      (s === i || s.matches === i || !1 === s.isQuantifier) &&
                        o &&
                        o.isGroup &&
                        ((o.isGroup = !1),
                        n ||
                          (y(o, a.groupmarker[0], 0),
                          !0 !== o.openGroup && y(o, a.groupmarker[1]))),
                        t(o);
                    });
                })(h),
                v.push(h)),
      ...
      function s(e, t, i) {
        ...
        function p(e, t, n) {
          (e[r] = (function (e) {
            ...
            (e["raw" + r] = t),
            void 0 !== s &&
              s.call(e.date, "month" == r ? parseInt(e[r]) - 1 : e[r]);
        }
        if ("string" == typeof c) {
          for (; (o = a(i).exec(t)); ) {
            var f = c.slice(0, o[0].length);
            n.hasOwnProperty(o[0]) &&
              ((l = n[o[0]][0]), (r = n[o[0]][2]), (s = n[o[0]][1]), p(u, f)),
              (c = c.slice(f.length));
          }
          return u;
        }
          ...
          datetime: {
            mask: function (e) {
              return (
                ...
                (e.displayFormat =
                  i[e.displayFormat] || e.displayFormat || e.inputFormat),
                (e.outputFormat =
            ...
            postValidation: function (e, t, n) {
              ...
              return (
                r &&
                  o.date.getTime() == o.date.getTime() &&
                  ((i = o),
                  (a = r),
                  (r =
                    (r =
                      (!isFinite(i.rawday) ||
                        ("29" == i.day && !isFinite(i.rawyear)) ||
                        new Date(
                          i.date.getFullYear(),
                          isFinite(i.rawmonth)
                            ? i.month
            ...
            onKeyDown: function (n, i, r, s) {
              if (n.ctrlKey && n.keyCode === t.keyCode.RIGHT) {
                for (
                  var l, u = new Date(), c = "";
                  (l = a(s).exec(s.inputFormat));

                )
                  "d" === l[0].charAt(0)
                    ? (c += o(u.getDate(), l[0].length))
                    : "m" === l[0].charAt(0)
                    ? (c += o(u.getMonth() + 1, l[0].length))
                    : "yyyy" === l[0]
                    ? (c += u.getFullYear().toString())
                    : "y" === l[0].charAt(0) &&
                      (c += o(u.getYear(), l[0].length));
        ...
        t.extendAliases({
          numeric: {
            ...
            postValidation: function (i, a, r) {
              ...
              var v = {
                caret:
                  c === n || a.pos !== n ? l + (r.numericInput ? -1 : 1) : l,
                buffer: p,
              ...
              if (i)
                switch (i.type) {
                  ...
                  case "checkval":
                    var s;
                    if (
                      ((l = o).parseMinMaxOptions === n &&
                        (null !== l.min &&
                          ((l.min = l.min
                            .toString()
                            .replace(
                              new RegExp(t.escapeRegex(l.groupSeparator), "g"),
                              ""
                            )),
                          "," === l.radixPoint &&
                ...
                validator: function (e, i, a, r, o, s) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      f.length > 1 &&
                        (f[1] = f[1].replace(/0/g, o.placeholder.charAt(0))),
                        "0" === f[0] &&
                          (f[0] = f[0].replace(/0/g, o.placeholder.charAt(0))),
            ...
            isComplete: function (e, n) {
              ...
              return (
                (i = (i = (i = (i = (i = i.replace(
                  ...
                  new RegExp(
                    t.escapeRegex(n.groupSeparator) + "([0-9]{3})",
                    "g"
                  ),
                  "$1"
                )),
          ...
          return (
            a.phoneCodes &&
              (a.phoneCodes &&
                ...
                ((function e(n, i, a) {
                  (i = i || ""), (a = a || r), "" !== i && (a[i] = {});
                  for (var o = "", s = a[i] || a, l = n.length - 1; l >= 0; l--)
                    (s[(o = (t = n[l].mask || n[l]).substr(0, 1))] =
                      s[o] || []),
